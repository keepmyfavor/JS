...
//顯示標題
echo"<TR><TD ALIGN=CENTER COLSPAN=20 BGCOLOR=#FFFFFF><FONTSIZE=5><B> $title </B><BR> $date " .$weekday[$week] . "</FONT></TD></TR>";
// echo"<TR><TD ALIGN=CENTER COLSPAN=15 BGCOLOR=#cc44ff><FONTSIZE=5><B> $title </B><BR> $date " .$weekday[$week] . "</FONT></TD></TR>";
//顯示檢測專案
echo"<TRBGCOLOR=#ccddee><TH>主機名稱</TH><TH>FTP</TH><TH>SMTP</TH><TH>HTTP</TH><TH>POP3</TH><TH>SAMBA</TH><TH>ERP</TH><TH>ERP</TH><TH>ERP</TH><TH>HTTPS</TH><TH>SAP</TH><TH>ERP</TH><TH>8088</TH></TR>";
...
//定義測試 port 清單
$port = array(21,25,80,110,139,211,212,213,443,3200,6666,8088);
